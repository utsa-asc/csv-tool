...
function updateAlt(asset, task) {
  var updatedAsset = asset;
  var displayName = updatedAsset.asset.xhtmlDataDefinitionBlock.metadata.displayName;
  var blockSDNs = [];
  var imageSDNs = [];
  ...
  image.structuredDataNodes.map(function(n) {
    if (n.identifier == "alt") {
      n.text = displayName;
    }
    imageSDNs.push(n);
  ...
  image.structuredDataNodes = imageSDNs;
  blockSDNs.push(image);
