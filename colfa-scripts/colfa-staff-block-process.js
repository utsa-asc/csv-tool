...
var fs = require('fs');
var tasks = [];
var writableStream = fs.createWriteStream("colfa/colfa-staff-posted.csv");
...
fs.createReadStream('colfa/colfa-staff-all.csv')
  ...
  */
  ...
  function processEachTask(task, callback) {
    ...
    let parentFolderPath = "faculty/_blocks/" + task.tag + "/staff";
    console.log("parentFolderPath is: " + parentFolderPath);
    ...
    payload.asset.xhtmlDataDefinitionBlock.tags = [{ "name" : task.tag }, { "name" : "staff"}];
