...
const GET_URI = "/api/v1/read/block/UC-VPAA-ASC-HALSTORE/programs/_blocks/"
...
async function completeTasks() {
  ...
  for (let t of tasks) {
    try {
      ...
      let stringPayload = cleanContent(JSON.stringify(payload));
...
function preparePayload(data, payloadJSON) {
  ...
  secondaryTitle = secondaryTitle.replaceAll(' & ', ' &amp; ');
  secondaryTitle = secondaryTitle.replaceAll('–', '&#8211;');
