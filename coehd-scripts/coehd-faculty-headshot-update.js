...
for (let i = 2; i < (maxRow + 2); i++) {
  ...
  if (dataSheet['A'+i] && newTask.tag == "bicultural-bilingual-studies") {
...
function generateFilePath(t) {
  var newFilePath = "faculty/headshots/" + t.tag + "/" + t.uri + ".jpg";
  return newFilePath;
}

function updateAsset(asset, task) {
  // console.log(asset.asset.xhtmlDataDefinitionBlock.structuredData.structuredDataNodes[1].structuredDataNodes[0].filePath);
  var updatedAsset = asset;
  const newFilePath = generateFilePath(task);
  // console.log(newFilePath);

  updatedAsset.asset.xhtmlDataDefinitionBlock.structuredData.structuredDataNodes[1].structuredDataNodes[0].filePath = newFilePath;
  delete updatedAsset.asset.xhtmlDataDefinitionBlock.structuredData.structuredDataNodes[1].structuredDataNodes[0].fileId;
  updatedAsset.asset.xhtmlDataDefinitionBlock.structuredData.structuredDataNodes[1].structuredDataNodes[1].text = cleanText(task.fullName);
   
  // console.log(updatedAsset.asset.xhtmlDataDefinitionBlock.structuredData.structuredDataNodes[1].structuredDataNodes[0]);
  // console.log(updatedAsset.asset.xhtmlDataDefinitionBlock.structuredData.structuredDataNodes[1].structuredDataNodes[1]);
