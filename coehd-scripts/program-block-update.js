...
const DEPTS = fs.readFileSync("coehd/departments.json");
const CERTS = fs.readFileSync("coehd/certificate.json");
const UGRAD = fs.readFileSync("coehd/undergraduate.json");
const GRAD = fs.readFileSync("coehd/graduate.json");
const DOCT = fs.readFileSync("coehd/doctoral.json");
// const TEST = fs.readFileSync("coehd/test.json");
const GET_URI = "/api/v1/read/block/COEHD-VPAA-DLS-HALSTORE/programs/_blocks/"
